...
class CounterStreamReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CounterStreamReply', createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'counter', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  CounterStreamReply._() : super();
  factory CounterStreamReply({
    $core.int? counter,
  }) {
    final _result = create();
    if (counter != null) {
  ...
  factory CounterStreamReply.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CounterStreamReply.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CounterStreamReply clone() => CounterStreamReply()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CounterStreamReply copyWith(void Function(CounterStreamReply) updates) => super.copyWith((message) => updates(message as CounterStreamReply)) as CounterStreamReply; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CounterStreamReply create() => CounterStreamReply._();
  CounterStreamReply createEmptyInstance() => create();
  static $pb.PbList<CounterStreamReply> createRepeated() => $pb.PbList<CounterStreamReply>();
  @$core.pragma('dart2js:noInline')
  static CounterStreamReply getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CounterStreamReply>(create);
  static CounterStreamReply? _defaultInstance;
...
class NamesReply extends $pb.GeneratedMessage {
  ...
  factory NamesReply.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NamesReply.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  NamesReply clone() => NamesReply()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NamesReply copyWith(void Function(NamesReply) updates) => super.copyWith((message) => updates(message as NamesReply)) as NamesReply; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NamesReply create() => NamesReply._();
  NamesReply createEmptyInstance() => create();
  static $pb.PbList<NamesReply> createRepeated() => $pb.PbList<NamesReply>();
  @$core.pragma('dart2js:noInline')
  static NamesReply getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NamesReply>(create);
